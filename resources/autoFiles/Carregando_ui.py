...
################################################################################
## Form generated from reading UI file 'Carregando.ui'
##
...
class Ui_Carregando(object):
    def setupUi(self, Carregando):
        if not Carregando.objectName():
            Carregando.setObjectName(u"Carregando")
        Carregando.resize(900, 700)
        Carregando.setMinimumSize(QSize(900, 700))
        self.centralwidget = QWidget(Carregando)
...
"background-color: rgb(119, 120, 115);")
        ...
        Carregando.setCentralWidget(self.centralwidget)

        self.retranslateUi(Carregando)

        QMetaObject.connectSlotsByName(Carregando)
    # setupUi

    def retranslateUi(self, Carregando):
        Carregando.setWindowTitle(QCoreApplication.translate("Carregando", u"MainWindow", None))
        self.label.setText("")
        self.label_processo.setText(QCoreApplication.translate("Carregando", u"iniciando conex\u00e3o com o servidor", None))
    # retranslateUi
