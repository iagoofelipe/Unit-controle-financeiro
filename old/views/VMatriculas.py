...
from controllers import MatriculasController

class MatriculasView(QMainWindow, Ui_Matriculas, App):
    def __init__(self, master):
        super(MatriculasView, self).__init__()
        self.setDefaults(master)

        self._model = MatriculasModel
        self._controller = MatriculasController
